...
export type GetJoinedServersResponse = GetJoinedServersResponses[keyof GetJoinedServersResponses];
...
export type GetUserQuizzesResponse = GetUserQuizzesResponses[keyof GetUserQuizzesResponses];
...
export type EnableAiAssistantResponse = EnableAiAssistantResponses[keyof EnableAiAssistantResponses];
...
export type ChatInSessionResponse = ChatInSessionResponses[keyof ChatInSessionResponses];
...
export type ChatInSessionStreamResponse = ChatInSessionStreamResponses[keyof ChatInSessionStreamResponses];
...
export type PostMaterialResponse = PostMaterialResponses[keyof PostMaterialResponses];
...
export type OauthAuthenticateResponse = OauthAuthenticateResponses[keyof OauthAuthenticateResponses];
...
export type GetServerMembersResponse = GetServerMembersResponses[keyof GetServerMembersResponses];
...
export type GetQuestionPoolResponse = GetQuestionPoolResponses[keyof GetQuestionPoolResponses];
...
export type StreamJobStatusResponse = StreamJobStatusResponses[keyof StreamJobStatusResponses];
